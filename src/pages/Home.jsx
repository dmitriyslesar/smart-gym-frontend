        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <h2 className="mt-3 text-2xl font-black text-white sm:text-2xl">Искусственный интеллект вместо тренера: Забудь про ручные крутилки и тумблеры. Умный алгоритм анализирует твой пульс, каденс и усталость в реальном времени, автоматически подстраивая нагрузку. Система понимает твой уровень физической подготовки и сама меняет угол наклона или сопротивление.</h2>
              <h2 className="mt-3 text-2xl font-black text-white sm:text-2xl">Полная аналитика твоего тела: Твои тренировки превращаются в чистые, полезные данные. Тренажер по Bluetooth гонит всю телеметрию (мощность в ваттах, пульсовые зоны, скорость) в мобильное приложение или облако. Отслеживай свой прогресс с абсолютной математической точностью.</h2>
              <h2 className="mt-3 text-2xl font-black text-white sm:text-2xl">Топовое железо под капотом: Современные электромагнитные системы маховиков работают абсолютно бесшумно. Никакого писка, износа цепей или проскальзывания ремней. </h2>
